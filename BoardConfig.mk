...
TARGET_PROVIDES_LIBRIL := vendor/zte/arthur/proprietary/libril.so
...
BOARD_KERNEL_CMDLINE := console=ttyMSM1,115200 androidboot.emmc=true androidboot.mode=normal androidboot.bootloader=0.85.0000 
...
#PRINT_SCREENINFO := true
#BOARD_HAS_JANKY_BACKBUFFER := true
#BOARD_USE_CUSTOM_RECOVERY_FONT:=
#TARGET_RECOVERY_RECOVERY_RGBX := true
...
BOARD_CUSTOM_GRAPHICS := ../../../device/zte/arthur/recovery/twrpgraphics.c

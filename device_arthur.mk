...
PRODUCT_COPY_FILES += \
    ...
    device/zte/arthur/prebuilt/lib/libcne.so:system/lib/libcne.so \
    device/zte/arthur/prebuilt/lib/libcneutils.so:system/lib/libcneutils.so \
    ...
    device/zte/arthur/prebuilt/etc/OperatorPolicy.xml:system/etc/OperatorPolicy.xml \
    device/zte/arthur/prebuilt/etc/UserPolicy.xml:system/etc/UserPolicy.xml
